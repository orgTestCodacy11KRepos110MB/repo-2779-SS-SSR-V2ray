# 付费机场推荐与评测/SSR和V2ray节点订阅机场,专线机场,科学上网（2022.01更新）
...
3.如果可以直接加telegram群，翻翻Telegram的历史消息，如果很糟糕肯定有其它用户吐槽的。我找的都是TG机场，相对透明，且竞争大，同样线路价格更低。
...
VIP3：标准12.90块/月,增量90G； 19.90块/月,200G； 年付232.9年,288GB流量/月； SSR+V2ray协议（建议这个起！）。          
VIP4：标准32.90块/月，350G； 增量41.90块/月,450G；年 付345.9/年,428GB流量/月； SSR+V2ray协议+BGP专有路线（最好买这个套餐）。          
