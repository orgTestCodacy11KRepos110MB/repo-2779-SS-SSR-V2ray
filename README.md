...
有分组：C优质和H精品组，入口都一样，出口精品的优先级会更高，人数不一样，精品人少，碎片负载会更少。如果有新产品或者遇到波动，会优先给精品接入更贵的产品以及优化。这2个组都是完全独立的入口出口，每个组都是2个地区入口，地域解析就近接入。有按量付费和自定义套餐选项，也可以当备用。 想找人数少的机场的，这家值得推荐。
