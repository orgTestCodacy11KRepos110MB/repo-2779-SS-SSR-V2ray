...
1.机场主要就是看线路。总体线路质量：华为云专线C>IELP专线>CN2>普通公网普通中转。总体越贵越好尽量选择有ILPC/IEPL专线和中转;BGP多入口中转的比单入口的要稳。在保证能流畅看视频前提下，稳定性最重要，然后才是追求更高的速度。一分钱一分货，vps 和线路注定，稳定&流量多&便宜==不存在。总体越贵越好（不绝对），不建议买直连ss/ssr/v2ray机场，v2ray起速慢点。尽量选择有内网专线和中转、BGP中转的，比较稳。 
